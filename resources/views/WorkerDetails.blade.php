...
<center>
    ...
    @endphp
      <table border="4" class="container">
        <thead>
            <tr>
                <th>Worker ID</th>
                <th>Name</th>
        ...
        <tbody>
           @foreach($Showdata as $v_dat)
              <tr>
                ...
                <td style="font-size: 15px">{{$v_dat->w_name}}</td>
                <td style="font-size: 15px">{{$v_dat->w_email}}</td>
                <td style="font-size: 15px">{{$v_dat->w_age}}</td>
                <td style="font-size: 15px">{{$v_dat->w_phone}}</td>
                <td style="font-size: 15px">{{$v_dat->w_date}}</td>
                <td style="font-size: 15px">{{$v_dat->w_area}}</td>
                <td style="font-size: 15px">{{$v_dat->free}}</td>
                 <td><a href="{{URL::to('/DeleteWorker/'.$v_dat->w_id)}}"><button>Delete</button></a></td>
              </tr>
           @endforeach     
        </tbody>
</table><br><br><br></br>
