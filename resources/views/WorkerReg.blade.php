     ...
     <div class="signup-main">    
      ...
      <div class="signup-block">
        <form action="{{url('/addworker')}}" method="Post">
          {{csrf_field()}}
        <input class="input100" type="text" name="w_id" placeholder="Enter Worker ID" value="w-00" required="">
        <input class="input100" type="text" name="w_name" placeholder="Enter Worker Name" required="">
        <input class="input100" type="text" name="w_email" placeholder="Enter Worker's Email" required="">
        <input class="input100" type="text" name="w_age" placeholder="Enter Worker's Age" required="">
        <input class="input100" type="text" name="w_phone" placeholder="Enter Worker's Phone Number"required=""><br>Joining date     
        <input class="input100" type="date" name="w_date" placeholder="Enter Join Date" required=""><br>
        <input class="input100" type="text" name="w_area" placeholder="Enter Working Area" required="">
        <input class="input100" type="text" name="free" placeholder="Is he available ?" required="">
        <div class="forgot-top-grids">            
            <div class="clearfix"> </div>
          </div>
          <input type="submit" name="addworker" value="Add now">                            
        </form>
