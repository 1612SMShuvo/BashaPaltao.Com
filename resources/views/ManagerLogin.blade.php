...
<div class="login-page">
    <div class="login-main">    
      ...
      <div class="login-block">
        <form action="{{URL::to('/Managerlogin')}}" method="post">
            {{ csrf_field() }}
                  @if(session()->has('Message'))
                    <div style="background-color: red; padding: 25px; color:black; font-size:18px">{{ session()->get('Message') }}</div><br>
                  @endif
          <input type="text" name="m_email" placeholder="Email" required="">
          <input type="password" name="m_pass" class="lock" placeholder="Password">
